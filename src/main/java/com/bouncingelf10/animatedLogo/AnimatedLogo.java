...
public class AnimatedLogo implements ModInitializer {
    ...
    public static final SoundEvent STARTUP_SOUND_EVENT = new SoundEvent(STARTUP_SOUND_ID);

    @Override
    public void onInitialize() {
        LOGGER.info("Initializing Startup Animation, DLS: {}", !isDarkLoadingScreenNotPresent());
        Registry.register(Registry.SOUND_EVENT, STARTUP_SOUND_ID, STARTUP_SOUND_EVENT);
    }
}
